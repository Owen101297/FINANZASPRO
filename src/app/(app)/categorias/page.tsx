    ...
    <div className="animate-fade-in">
      <header className="mb-5 flex items-center justify-between">
        <div>
          ...
          <p className="mt-0.5 text-sm text-muted-foreground">Organiza tus movimientos</p>
        </div>
        <button
          onClick={openCreate}
      ...
      {isLoading ? (
        ...
        <Card>
          <EmptyState
            ...
            hint="Las categorías te permiten ver en qué se va tu dinero."
          />
        </Card>
      )}
      ...
      <Modal
        ...
        title={editing ? "Editar categoría" : `Nueva categoría de ${tab === "INCOME" ? "ingreso" : "gasto"}`}
      >
