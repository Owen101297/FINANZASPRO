    ...
    <>
      <div className="relative mx-auto mt-2 h-56 max-w-xs">
        ...
        <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
          <span className="text-[10px] uppercase tracking-wide text-muted-foreground">{t("total")}</span>
      ...
      <Card className="mt-6">
          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={dailySeries}>
              ...
              <ChartTooltip
                ...
                formatter={(value) => [formatCurrency(Number(value)), t("expense")]}
        ...
        <p className="mt-2 text-center text-[11px] text-muted-foreground">
          {t("movementsStats", { count: transactionCount, amount: formatCurrency(subscriptionsMonthly) })}
        </p>
      </Card>
    </>
  );
